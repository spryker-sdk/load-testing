...
trait AddItemToCartLessOrEqualFiftyItemsFullFlowApiBase {

  lazy val scenarioName = "Add Item To Cart Less Or Equal Fifty Items Full Flow Api"
  ...
  val prepareCartWithDifferentItemsRequest = http("Prepare Cart With Different Items Request")
  ...
  val scn = scenario(scenarioName)
    ...
    .pause(3)
    .repeat(50) {
      exec(prepareCartWithDifferentItemsRequest)
    }
    .pause(3)
    .exec(addToCartRequest)
}

class AddItemToCartLessOrEqualFiftyItemsFullFlowApiRamp extends Simulation with AddItemToCartLessOrEqualFiftyItemsFullFlowApiBase {

  override lazy val scenarioName = "Add Item To Cart Less Or Equal Fifty Items Full Flow Api [Incremental]"
...
class AddItemToCartLessOrEqualFiftyItemsFullFlowApiSteady extends Simulation with AddItemToCartLessOrEqualFiftyItemsFullFlowApiBase {

  override lazy val scenarioName = "Add Item To Cart Less Or Equal Fifty Items Full Flow Api [Steady RPS]"
