...
class AddOfferToGuestCartRamp extends Simulation with AddOfferToGuestCartBase {

    override lazy val scenarioName = "Add Offer To Guest Cart [Incremental]"
...
class AddOfferToGuestCartSteady extends Simulation with AddOfferToGuestCartBase {

    override lazy val scenarioName = "Add Offer To Guest Cart [Steady RPS]"
