...
trait CheckoutFullFlowLessOrEqualFiftyItemsApiBase {

  lazy val scenarioName = "Checkout Full Flow With Less Or Equal Fifty Items Api"
...
class CheckoutFullFlowLessOrEqualFiftyItemsApiRamp extends Simulation with CheckoutFullFlowLessOrEqualFiftyItemsApiBase {

  override lazy val scenarioName = "Checkout Full Flow With Less Or Equal Fifty Items Api [Incremental]"
...
class CheckoutFullFlowLessOrEqualFiftyItemsApiSteady extends Simulation with CheckoutFullFlowLessOrEqualFiftyItemsApiBase {

  override lazy val scenarioName = "Checkout Full Flow With Less Or Equal Fifty Items Api [Steady RPS]"
