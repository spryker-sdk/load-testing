...
trait CsvFixturesAddToCartApiBase {

  lazy val scenarioName = "Csv Fixtures Add To Cart Api"

  val httpProtocol = GlueProtocol.httpProtocol

  val csvFixturesAddToCartRequest = http("Csv Fixtures Add To Cart Api")
    .post("/customer-fixture")
    .body(StringBody("""{"data":{"type":"customer-fixture","attributes":{"itemsQuantity": 1}}}""")).asJson
    .check(
...
class CsvFixturesAddToCartApiRamp extends Simulation with CsvFixturesAddToCartApiBase {

  override lazy val scenarioName = "Csv Fixtures Add To Cart Api [Incremental]"
...
class CsvFixturesAddToCartApiSteady extends Simulation with CsvFixturesAddToCartApiBase {

  override lazy val scenarioName = "Csv Fixtures Add To Cart Api [Steady RPS]"
