...
trait FirstDataNotificationsBase {
  lazy val scenarioName = "First Data Notifications Api"
...
class FirstDataNotificationsRamp extends Simulation with FirstDataNotificationsBase {

  override lazy val scenarioName = "First Data Notifications Api [Incremental]"
...
class FirstDataNotificationsSteady extends Simulation with FirstDataNotificationsBase {

  override lazy val scenarioName = "First Data Notifications Api [Steady RPS]"
