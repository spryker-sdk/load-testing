...
trait GuestCheckoutWithOffersApiBase {

    lazy val scenarioName = "Guest Checkout With Offers Api"
    ...
    val addToCartRequest = http("Add to Guest Cart")
        ...
        .body(StringBody("""{"data": {"type": "guest-cart-items", "attributes": {"sku": "${product_sku}", "productOfferReference": "${product_offer_reference}", "quantity": 10}}}""")).asJson
...
class GuestCheckoutWithOffersApiRamp extends Simulation with GuestCheckoutWithOffersApiBase {

    override lazy val scenarioName = "Guest Checkout With Offers Api [Incremental]"
...
class GuestCheckoutWithOffersApiSteady extends Simulation with GuestCheckoutWithOffersApiBase {

    override lazy val scenarioName = "Guest Checkout With Offers Api [Steady RPS]"
