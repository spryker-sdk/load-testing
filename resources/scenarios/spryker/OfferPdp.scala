...
trait OfferPdpBase {
    ...
    lazy val scenarioName = "PDP offer page"
...
class OfferPdpRamp extends Simulation with OfferPdpBase {

    override lazy val scenarioName = "PDP offer page [Incremental]"
...
class OfferPdpSteady extends Simulation with OfferPdpBase {

    override lazy val scenarioName = "PDP offer page [Steady RPS]"
