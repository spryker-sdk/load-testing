...
class OfferPdpApiRamp extends Simulation with OfferPdpApiBase {

    override lazy val scenarioName = "PDP Offer API [Incremental]"
...
class OfferPdpApiSteady extends Simulation with OfferPdpApiBase {

    override lazy val scenarioName = "PDP Offer API [Steady RPS]"
