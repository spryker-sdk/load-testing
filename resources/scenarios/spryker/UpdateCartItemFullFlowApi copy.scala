...
trait UpdateCartItemFullFlowApiBase {

  lazy val scenarioName = "Update Cart Item Full Flow Api"
  ...
  val updateCartItemRequest = http("Update Cart Request")
    .patch("/carts/${cart_id}/items/${sku}_${sku}_${merchant_reference}")
  ...
  val scn = scenario(scenarioName)
    ...
    .pause(3)
    .exec(updateCartItemRequest)
}

class UpdateCartItemFullFlowApiRamp extends Simulation with UpdateCartItemFullFlowApiBase {

  override lazy val scenarioName = "Update Cart Item Full Flow Api [Incremental]"
...
class UpdateCartItemFullFlowApiSteady extends Simulation with UpdateCartItemFullFlowApiBase {

  override lazy val scenarioName = "Update Cart Item Full Flow Api [Steady RPS]"
